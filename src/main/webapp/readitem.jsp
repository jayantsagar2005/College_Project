	...
	<div>
			<header class="back-colors py-4 d-flex justify-content-between align-items-center">
			    <div class="text-center flex-grow-1">
			        <h1 class="fw-bolder font-color m-0">READ ITEMS</h1>           
	...
	<div class="py-5">
		...
		<div class="row">
			<div class="col-4 my-2">
				<div>
					<h2 class="text-center text-warning fw-bolder">Breakfast</h2>			
				</div>
									...
									<div class="card mx-1 my-2 back-colors">
										<div class="d-flex card-body">
											<div>
												...
												<h5 class="card-title text-white fw-bolder text-center mt-3"><i class="fa fa-indian-rupee-sign px-1"></i><%= list.get(i).getItemPrice() %></h5>
											</div>
											<div class="mx-2">
			...
			<div class="col-4 my-2">
				<div>
					<h2 class="text-center text-warning fw-bolder">Lunch</h2>			
				</div>
				<div class="row">
					<div class="col-12">
						<%
			...
			<div class="col-4 my-2">
				<div>
					<h2 class="text-center text-warning fw-bolder">Dinner</h2>			
				</div>
				<div class="row">
					<div class="col-12">
						<%
