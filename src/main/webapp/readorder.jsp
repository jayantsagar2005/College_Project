		...
		<div>
			<div class="back-colors py-4">
				<div class="text-center">
					<h1 class="fw-bolder font-color">READ ORDER</h1>
			  ...
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="navbarSupportedContent">
			      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
			        ...
			        %>
			        <li class="nav-item">		
			          <a class="nav-link fs-5 fw-bolder text-warning" href="readorder.jsp">Read Ordered (<%= pendingOrder %>)</a>
			        </li>
			        <li class="nav-item">
			          <a class="nav-link fs-5 active fw-bolder text-white" href="ReadMessageServlet">Read Message (<%= contact.unreadCount() %>)</a>
			        </li>
			        <li class="nav-item">		
			...
			<div class="mt-2">
				<table class="table table-secondary table-bordered">
		    		<thead>
						<tr class="table-warning">
						    <th scope="col" class="text-center fs-4 fw-bolder">Name</th>
						    <th scope="col" class="text-center fs-4 fw-bolder">G-mail</th>
						    <th scope="col" class="text-center fs-4 fw-bolder">People No</th>
						    <th scope="col" class="text-center fs-4 fw-bolder">Request</th>
				...
				<%
			    	ArrayList<BookTablePojo> list = foodOrderDaoImp.readData();
			    	for(BookTablePojo cp : list){
			    %>
			    		<tbody>
			    			<tr class="table-success">
			    				<td class="pt-3"><%= cp.getName() %></td>
			    				<td class="pt-3"><%= cp.getGmail() %></td>
			    				<td class="pt-3"><%= cp.getPeopleNo() %></td>
			    				<td class="pt-3"><%= cp.getFood() %></td>
			    				...
			    				<td style="width: 180px;">
			    					<div class="d-flex">
							    		...
							    		<form action="UpdateOrderServlet" method="post" class="ms-2">
							    			<input type="hidden" name="sno" value="<%= cp.getsNo() %>">
							    			<%
